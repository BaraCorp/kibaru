...
urlpatterns = patterns('',
                       ...
                       url(r'^add_website/$', views.add_website,
                           name='add_website'),
                       url(r'^price-kib-ml/$', views.proposition_price,
                           name='proposition-price'),
                       url(r'^edit_article/(?P<id>\d+)$',
                           views.edit_article, name='edit_article'),
                       url(r'^del_article/(?P<id>\d+)$',
                           views.del_article, name="del_article"),
                       url(r'^del_video/(?P<id>\d+)$',
                           views.del_video, name="del_video"),
                       url(r'^edit_new/(?P<id>\d+)$',
