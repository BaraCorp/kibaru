...
def normalize_query(query_string,
    ...
    ''' Divise la chaîne de requête dans les mots clés strictement lié,
        se débarrasser des espaces non nécessaires et le regroupement cité mots ensemble.
        Exemple:
...
def get_query(query_string, search_fields):
    ''' Retourne une requête, qui est une combinaison d'objets Q. Cette combinaison
         vise à rechercher des mots-clés dans un modèle en testant les champs de recherche donnés.
