...
urlpatterns = patterns(
    ...
    url(r'^art/(?P<slug>.*)', views.display_article, name='art'),
    url(r'^new/(?P<id>[-\w\d]*)$', views.display_new, name='news'),
    ...
    url(r'^videos/$', views.display_videos, name='all_videos'),
    url(r'^poll', views.poll, name='poll'),
    url(r'^sport/$', views.display_heading, name='all_sport'),
    url(r'^culture/$', views.display_heading, name='all_sport'),
)
